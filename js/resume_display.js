$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*开始了吗？</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*咳（清嗓子）</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫李蔚鹏，是一名小工程师</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*身为程序员，我的主要工作当然是负责码代码啦</div>",1000);
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*你是不是厌倦了那些白底黑字？</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*那么让我们来做一些改变吧！</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*在这整个页面里写代码多少会让人有些不舒服</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我得准备创建一个区域来更好的显示我的代码</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<p><div class='code writecode'><span class='selector'>#content</span> {</div>");
  	...
  	c.setClass("#style-text", [{
		"name": "-webkit-transform",
		"val": "translateX(98.5%) rotateY(-5deg)"
	}]);
